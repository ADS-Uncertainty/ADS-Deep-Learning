...
'''
Tips：
1. The calculation of Safety Metrics requires the re collection of data, as this type of data is fundamentally different from MCD and DE
'''
...
net.eval()  # 设置模型为评估模式,Dropout start!
...
for noise_level in NOISE_LEVEL:
    ...
    np.save('/media/safetydatacollect/'+ str(noise_level) + '_mux.npy', x_all)
    np.save('/media/safetydatacollect/'+ str(noise_level) + '_muy.npy', y_all)
    # ==================================================================================
