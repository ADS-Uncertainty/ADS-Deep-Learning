...
"""
Calculate EU by MC Dropout
"""

# Replace it with your target file path
x_all = np.load('/media/TABLE-MCD/noise_level_mux.npy')
y_all = np.load('/media/TABLE-MCD/noise_level_muy.npy')
# Ground Truth traj
gt_y = np.load('/media/TABLE-MCD/L_0_y_gty.npy')
